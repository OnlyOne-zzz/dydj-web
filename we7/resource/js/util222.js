...
function getSign(e, t, a) {
    var n = require("underscore.js"), r = require("md5.js"), o = "", i = getUrlParam(e, "sign");
    ...
    o = n.sortBy(o, "name"), o = n.uniq(o, !0, "name");
    for (var c = "", g = 0; g < o.length; g++) o[g] && o[g].name && o[g].value && (c += o[g].name + "=" + o[g].value, 
    g < o.length - 1 && (c += "&"));
    return i = r(c + (a = a || getApp().siteInfo.token));
}
...
util.url = function(e, t) {
    ...
    return n;
}, util.geturl = function(e) {
    var t = wx.getStorageSync("userInfo").sessionid, a = e.url;
    if (-1 == a.indexOf("http://") && -1 == a.indexOf("https://") && (a = util.url(a)), 
    getUrlParam(a, "state") || e.data && e.data.state || !t || (a = a + "&state=we7sid-" + t), 
    !e.data || !e.data.m) {
        var n = getCurrentPages();
        n && (n = n[getCurrentPages().length - 1]).__route__ && (a = a + "&m=" + n.__route__.split("/")[0]);
    }
    var r = getSign(a, e.data);
    return r && (a = a + "&sign=" + r), a || !1;
    ...
    var a = wx.getStorageSync("userInfo").sessionid, o = n.url;
    if (-1 == o.indexOf("http://") && -1 == o.indexOf("https://") && (o = util.url(o)), 
    getUrlParam(o, "state") || n.data && n.data.state || !a || (o = o + "&state=we7sid-" + a), 
    !n.data || !n.data.m) {
        var i = getCurrentPages();
        i && (i = i[getCurrentPages().length - 1]).__route__ && (o = o + "&m=" + i.__route__.split("/")[0]);
    }
    var s = getSign(o, n.data);
    ...
    if (wx.showNavigationBarLoading(), n.showLoading && util.showLoading(), n.cachetime) {
        ...
        if (c && c.data) {
            ...
            n.success && "function" == typeof n.success && n.success(c), console.log("cache:" + o), 
    ...
    wx.request((_defineProperty(e = {
        ...
        var t = require("md5.js")(o), a = wx.getStorageSync(t);
...
util.getUserInfo = function(t) {
    ...
    if (console.log(e), e.sessionid) {
        console.log("fffffffffff");
        var a = wx.getStorageSync("wxInfo");
        util.request({
            ...
            cachetime: 0,
            success: function(e) {
                e.data.errno || (userInfo.wxInfo = a.userInfo, userInfo.memberInfo = e.data.data, 
                console.log(userInfo), wx.setStorageSync("userInfo", userInfo)), console.log(t), 
                "function" == typeof t && t(userInfo);
            }
        });
    } else console.log("nnnnn"), console.log("start login"), wx.login({
        success: function(e) {
            util.request({
                ...
                cachetime: 0,
                success: function(e) {
                    e.data.errno || (userInfo.sessionid = e.data.data.sessionid, console.log(e), wx.setStorageSync("userInfo", userInfo), 
                    "function" == typeof t && t());
                }
            });
        },
