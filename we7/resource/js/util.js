...
util.base64Encode = function(e) {
    ...
    !e.data || !e.data.m) {
        ...
        a && (a = a[getCurrentPages().length - 1]).__route__ && (n = n + "&m=" + a.__route__.split("/")[0]);
    }
    ...
    console.log(a), a.sessionid ? util.checkSession({
        success: function() {
            n ? (console.log(n), util.upadteUser(n, function(e) {
                "function" == typeof t && t(e);
