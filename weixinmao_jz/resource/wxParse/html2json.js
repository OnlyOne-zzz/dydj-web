    ...
    return HTMLParser(e, {
        start: function(e, t, r) {
            ...
            0 !== t.length && (a.attr = t.reduce(function(e, t) {
                ...
                return "class" == r && (console.dir(s), a.classStr = s), "style" == r && (console.dir(s), 
                a.styleStr = s), s.match(/ /) && (s = s.split(" ")), e[r] ? Array.isArray(e[r]) ? e[r].push(s) : e[r] = [ e[r], s ] : e[r] = s, 
                e;
            }, {})), "img" === a.tag) {
            ...
            delete result.source), 0 === d.length) p.nodes.push(t); else {
                var r = d[0];
