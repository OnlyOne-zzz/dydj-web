...
Page(_defineProperty({
    ...
    onLoad: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                t.data.message.errno || (e.data.title = t.data.data.title + "-" + wx.getStorageSync("shopinfo").name, 
                wx.setNavigationBarTitle({
                    title: e.data.title
                }), e.setData({
                    data: t.data.data,
                    content: WxParse.wxParse("article", "html", t.data.data.content, e, 5)
                }));
            },
            complete: function() {
    ...
    return {
        ...
        path: "/weixinmao_jz/pages/newsdetail/index?id=" + this.data.id
    };
}));